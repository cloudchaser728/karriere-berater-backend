...
- Seiten-Wrapper: font-family:'Work Sans',sans-serif; max-width:900px; margin:0 auto; padding:0 16px; box-sizing:border-box;
...
- Grids: display:grid; grid-template-columns:repeat(auto-fit,minmax(140px,1fr)); gap:12px;
