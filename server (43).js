...
<div class="career-path-card">
  ...
  <div class="job-search-buttons">
    ...
    ` : `
    <a href="https://www.hochschulkompass.de/studium/studiengangsuche/erweiterte-studiengangsuche.html?tx_szhrksearch_pi1%5Bsearch%5D=1&tx_szhrksearch_pi1%5BQUICK%5D=1&tx_szhrksearch_pi1%5Bstudtyp%5D=3&tx_szhrksearch_pi1%5Bfach%5D=[STUDIENGANG]&tx_szhrksearch_pi1%5Bort%5D=${locationEncoded}" target="_blank" class="btn btn-accent" style="margin: 10px 5px; display: inline-block;">
      🎓 Hochschulkompass
    </a>
    ...
    <a href="https://www.wegweiser-duales-studium.de/suche/?q=[STUDIENGANG]+${locationEncoded}" target="_blank" class="btn" style="margin: 10px 5px; display: inline-block; background: #10b981;">
      💼 Duales Studium finden
    </a>
    `}
  </div>
