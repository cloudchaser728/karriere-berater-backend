...
${formData.bildungsweg_ziel === 'uni' ? `→ Will UNI: ALLE 3 Karrierewege = Universitätsstudiengänge! ABSOLUTES VERBOT: KEINE Ausbildungen, KEINE FH, KEINE dualen Studiengänge!
MEDIZIN-REGEL: Wenn Interesse an Gesundheit/Medizin/Chirurgie → Humanmedizin, Zahnmedizin, Pharmazie, Gesundheitswissenschaften B.Sc. empfehlen – NICHT Notfallsanitäter, NICHT Physiotherapeut (das sind Ausbildungen!)` :
  formData.bildungsweg_ziel === 'fh' ? '→ Will FH: Alle 3 Karrierewege = FH/Duale Studiengänge! KEINE Uni! KEINE Ausbildungen!' :
  formData.bildungsweg_ziel === 'ausbildung' ? '→ Will AUSBILDUNG trotz Abitur: Karriereweg 1 = Universitätsstudium (passend zu den Interessen), Karriereweg 2 + 3 = Ausbildungsberufe! Hinweis einbauen: Mit Abitur hast du immer noch die Option zu studieren – Ausbildung ist trotzdem eine starke Wahl!' :
...
${formData.bildungsweg_ziel === 'fh' ? '→ Will FH: Alle 3 Karrierewege = FH/Duale Studiengänge! KEINE Uni!' :
  formData.bildungsweg_ziel === 'ausbildung' ? '→ Will AUSBILDUNG trotz Fachabitur: Karriereweg 1 = FH/Duales Studium (passend zu den Interessen), Karriereweg 2 + 3 = Ausbildungsberufe! Hinweis einbauen: Mit Fachabitur hast du immer noch die Option an eine FH zu gehen – Ausbildung ist trotzdem eine starke Wahl!' :
