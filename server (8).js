...
app.post('/lebenslauf-generator', async (req, res) => {
    try {
        const {
            vorname, nachname, geburtsdatum, stadt, email, telefon,
            schule, abschluss, abschlussjahr, notendurchschnitt,
        ...
        console.log(`📄 Lebenslauf-Generator angefragt: ${vorname} ${nachname} → ${zielberuf}`);

        const prompt = `Du bist ein erfahrener Bewerbungscoach für Ausbildungsplätze in Deutschland. Erstelle auf Basis folgender Angaben einen professionellen, tabellarischen Lebenslauf UND ein passendes Anschreiben für eine Bewerbung als "${zielberuf}".

ANGABEN:
- Name: ${vorname} ${nachname}
- Geburtsdatum: ${geburtsdatum || 'nicht angegeben'}
- Wohnort: ${stadt || 'nicht angegeben'}
- E-Mail: ${email || 'nicht angegeben'}
- Telefon: ${telefon || 'nicht angegeben'}
- Schule: ${schule}
- Abschluss: ${abschluss}
- Abschlussjahr: ${abschlussjahr || 'nicht angegeben'}
...
WICHTIGE REGELN:
- Erfinde NIEMALS Fakten (keine erfundenen Praktika, Noten oder Fähigkeiten) – nutze NUR die gegebenen Angaben. Wenn etwas fehlt, lass es im Lebenslauf einfach weg statt es zu erfinden.
- Das Anschreiben soll die vorhandenen Stärken glaubwürdig mit dem Zielberuf "${zielberuf}" verknüpfen.
...
Antworte AUSSCHLIESSLICH mit einem validen JSON-Objekt in genau diesem Format, ohne Zusatztext, ohne Markdown-Codeblock:
{
  ...
  "anschreiben": {
    "betreff": "Bewerbung um einen Ausbildungsplatz als ${zielberuf}",
