...
${formData.bildungsweg_ziel === 'uni' ? '→ Will UNI: Alle 3 Karrierewege = Universitätsstudiengänge!' :
  ...
  formData.bildungsweg_ziel === 'ausbildung' ? '→ Will AUSBILDUNG trotz Abitur: Alle 3 = Ausbildungsberufe! Hinweis: Mit Abitur jederzeit noch studieren möglich!' :
  '→ UNSICHER: 2 Studiengänge (Uni oder FH) + 1 Ausbildung!'}
` : ''}
...
${formData.bildungsweg_ziel === 'fh' ? '→ Will FH: Alle 3 Karrierewege = FH/Duale Studiengänge! KEINE Uni!' :
  formData.bildungsweg_ziel === 'ausbildung' ? '→ Will AUSBILDUNG trotz Fachabitur: Alle 3 = Ausbildungsberufe! Hinweis: Mit Fachabitur jederzeit noch FH möglich!' :
...
**SCHÜLER OBERSTUFE – BILDUNGSWEG-PRÄFERENZ: ${formData.bildungsweg_ziel || 'unsicher'}**
${formData.bildungsweg_ziel === 'ausbildung' ? '→ Will Ausbildung: Alle 3 Ausbildungsberufe!' :
  formData.bildungsweg_ziel === 'fh' ? '→ Will FH: Alle 3 FH/Duale Studiengänge!' :
  formData.bildungsweg_ziel === 'uni' ? '→ Will Uni: Alle 3 Uni-Studiengänge!' :
  '→ Unsicher: 2 Studiengänge + 1 Ausbildung!'}
` : ''}
...
5. **KONKRETE NÄCHSTE SCHRITTE**
   ...
   ❌ NIEMALS "Praktikum suchen" als Schritt nennen – bereits im Formular abgefragt!
   ❌ NIEMALS "Initiativ-E-Mail an Behörde/Bundeswehr/Polizei/Zoll/Feuerwehr" empfehlen – Behörden haben feste Bewerbungsportale!
   ❌ NIEMALS ausbildung.de für Staatsberufe empfehlen – die sind nicht dort inseriert!

   🎯 WELCHE SCHRITTE FÜR WELCHEN BERUF – GRUPPE ERKENNEN UND STRIKT EINHALTEN:

   ═══════════════════════════════
   GRUPPE 1 – STAATSBERUFE (Polizei, Bundespolizei, Zoll, Feuerwehr, Bundeswehr, JVA, Gerichtsvollzieher, Verwaltungsbeamter):
   ═══════════════════════════════
   Schritt 1 – Sofort: Offizielles Bewerbungsportal öffnen:
     • Polizei NRW → polizei.nrw/karriere | Bundespolizei → bundespolizei.de/bewerbung
     • Zoll → bewerbung.zoll.de | Feuerwehr → Berufsfeuerwehr der Stadt ${location}
     • Bundeswehr → bundeswehr-karriere.de/karrierecenter (Termin buchen!)
     • JVA → Justizministerium des jeweiligen Bundeslandes
   Schritt 2 – Diese Woche: Einstellungstest kennenlernen:
     • Welche Tests gibt es genau für DIESEN Beruf? (Sporttest, Wissenstest, psychologischer Test, Sehtest)
     • Kostenlos üben auf: einstellungstest.de, polizei-einstellungstest.de
   Schritt 3 – Nächster Monat: Sporttest vorbereiten:
     • Konkrete Anforderungen für DIESEN Beruf nennen (z.B. Polizei: 1000m unter X Min., X Liegestütze, Schwimmen)
     • Trainingsplan starten – 8 Wochen vor Test
   Schritt 4 – 3-6 Monate: Bewerbung einreichen:
     • Bewerbungsfrist checken (meist 1 Jahr im Voraus!)
     • Erste-Hilfe-Schein machen falls gefordert
     • Unterlagen vorbereiten: Schulzeugnis, Lichtbild, Führungszeugnis
   Schritt 5 – Langfristig: Laufbahnaufstieg:
     • Konkreter Aufstiegsweg für DIESEN Beruf (z.B. Polizei: mittlerer → gehobener Dienst durch Studium berufsbegleitend)

   ═══════════════════════════════
   GRUPPE 2 – PRIVATE AUSBILDUNGSBERUFE (Handwerk, Pflege, Gastro, Kaufmännisch, IT-Ausbildung):
   ═══════════════════════════════
   Schritt 1 – Sofort: Konkrete Ausbildungsplätze suchen:
     • ausbildung.de, azubi.de oder Google Jobs mit exaktem Berufsnamen + ${location}
     • 2-3 ECHTE Firmen/Betriebe in ${location} namentlich nennen die diesen Beruf ausbilden
   Schritt 2 – Diese Woche: Bewerbungsunterlagen vorbereiten:
     • Lebenslauf auf canva.com erstellen (kostenlos, professionelle Vorlagen)
     • Anschreiben mit den konkreten Firmennamen aus Schritt 1
   Schritt 3 – Nächster Monat: Bewerbungen abschicken:
     • Bewerbungsfristen für diesen Beruf nennen (z.B. viele Betriebe nehmen ab September für nächstes Jahr)
     • IHK/HWK Lehrstellenbörse als zusätzliche Quelle
   Schritt 4 – 3-6 Monate: Vorbereitung auf Vorstellungsgespräch:
     • Was wird im Gespräch gefragt für DIESEN Beruf? Konkrete Tipps
     • Ggf. Eignungstest üben (z.B. für IT, Bank, Versicherung)
   Schritt 5 – Langfristig: Aufstieg nach Ausbildung:
     • Konkreter Weiterbildungsweg + Gehaltssprung (z.B. Meister, Techniker, Betriebswirt)

   ═══════════════════════════════
   GRUPPE 3 – DUALES STUDIUM (FH, BA, DHBW):
   ═══════════════════════════════
   Schritt 1 – Sofort: Unternehmen mit dualem Studium suchen:
     • ausbildungsplatz.de/duales-studium, stellenwerk.de oder Google: "[Studiengang] duales Studium ${location}"
     • 2-3 ECHTE Unternehmen in ${location} nennen die dieses duale Studium anbieten
   Schritt 2 – Diese Woche: FH/BA Bewerbung vorbereiten:
     • Welche FH/BA/DHBW in der Nähe von ${location} bietet diesen Studiengang an?
     • Zulassungsvoraussetzungen checken (Fachabitur reicht? NC?)
   Schritt 3 – Nächster Monat: Unternehmensbewerbung abschicken:
     • Beim dualen Studium ZUERST Unternehmen bewerben, dann wird man an FH angemeldet
     • Bewerbungsfristen oft früh: Oktober-Januar für September-Start
   Schritt 4 – 3-6 Monate: Auswahlverfahren vorbereiten:
     • Assessment Center, Eignungstest oder Vorstellungsgespräch für DIESEN Studiengang
   Schritt 5 – Langfristig: Master / Aufstieg:
     • Master-Studium nach Bachelor + Gehaltssprung konkret benennen

   ═══════════════════════════════
   GRUPPE 4 – UNI-STUDIUM / NC-FÄCHER (Medizin, Jura, Psychologie, Architektur etc.):
   ═══════════════════════════════
   Schritt 1 – Sofort: NC checken und realistisch einschätzen:
     • Hochschulstart.de (für Medizin, Pharmazie, Tiermedizin, Psychologie)
     • Welche Uni in der Nähe von ${location} bietet diesen Studiengang an + aktueller NC
   Schritt 2 – Diese Woche: Abi-Strategie festlegen:
     • Welche Fächer besonders wichtig für den NC in DIESEM Studiengang?
     • Wenn NC knapp: Wartesemester, Auslandsstudium, private Uni als Alternative benennen
   Schritt 3 – Nächster Monat: Bewerbung vorbereiten:
     • Studienplatzbewerbung über hochschulstart.de ODER direkt bei Uni
     • Bewerbungsfristen: 15. Januar (WS) und 15. Juli (SS)
   Schritt 4 – 3-6 Monate: Alternativen absichern:
     • Plan B konkret benennen falls NC nicht reicht (z.B. Ausland, Wartesemester, verwandter Studiengang)
   Schritt 5 – Langfristig: Spezialisierung + Gehalt:
     • Konkrete Fachrichtung nach Studium + realistisches Einstiegsgehalt

   <div class="section-container">
     <h3>🎯 DEINE nächsten Schritte</h3>
     <div class="step-item">
       <span class="step-number">1</span>
       <div class="step-content"><strong>Sofort (heute noch):</strong> [Gruppe erkennen → passenden Schritt 1 einsetzen – mit echten Links/Namen/Portalen für DIESEN konkreten Beruf in ${location}]</div>
     </div>
     <div class="step-item">
       <span class="step-number">2</span>
       <div class="step-content"><strong>Diese Woche:</strong> [Gruppe erkennen → passenden Schritt 2 einsetzen – konkret, keine generischen Floskeln]</div>
     </div>
     <div class="step-item">
       <span class="step-number">3</span>
       <div class="step-content"><strong>Nächster Monat:</strong> [Gruppe erkennen → passenden Schritt 3 einsetzen]</div>
     </div>
     <div class="step-item">
       <span class="step-number">4</span>
       <div class="step-content"><strong>In 3-6 Monaten:</strong> [Gruppe erkennen → passenden Schritt 4 einsetzen]</div>
     </div>
     <div class="step-item">
       <span class="step-number">5</span>
       <div class="step-content"><strong>Langfristig:</strong> [Gruppe erkennen → passenden Schritt 5 einsetzen – konkreter Aufstieg + Gehaltssprung]</div>
     </div>
   </div>
