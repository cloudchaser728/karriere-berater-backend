...
- VERBOTEN wenn security_art gesetzt: Eventmanager, Sicherheitsbeauftragter, Hausmeister, Ordnungsdienst – das sind KEINE Berufe die jemand meint der Polizei/Feuerwehr/Bundeswehr angekreuzt hat!
...
${formData.security_art ? `- **SICHERHEIT-UNTERPUNKTE: ${Array.isArray(formData.security_art) ? formData.security_art.join(', ') : formData.security_art}** → Muss in konkreten Polizei/Feuerwehr/Bundeswehr/Zoll-Beruf resultieren!` : ''}
