...
app.post('/berufslexikon', async (req, res) => {
    try {
        ...
        const prompt = `Du bist ein Karriereexperte. Erstelle eine vollständige, informative HTML-Seite über den Beruf/Studiengang: "${beruf}".
...
(Falls Studiengang: Einstieg, Junior, Senior, Lead)

4. KARRIEREWEGE & AUFSTIEG (3 Karten)
- Konkrete Aufstiegsmöglichkeiten mit Gehalt

5. ZUKUNFTSPROGNOSE (4 Balken)
- Jobsicherheit
- Nachfrage am Markt  
- KI-Automatisierungsrisiko
- Aufstiegspotenzial

6. VORTEILE & NACHTEILE (2 Spalten)

7. WEITERBILDUNGSMÖGLICHKEITEN (4 Karten)
- Konkrete Weiterbildungen mit Gehaltssprung

8. VORAUSSETZUNGEN & BEWERBUNG
- Schulabschluss
- Was mitbringen
- Wo bewerben
...
- Überschriften: font-family:'Crimson Pro',serif; color:#0f1f3d; border-bottom:2px solid #c9a84c; padding-bottom:10px; margin-bottom:16px
- Gehaltstabelle: width:100%; border-collapse:collapse mit th background:#0f1f3d color:white
- Am Ende IMMER diese CTA-Box einfügen:
...
<p style="opacity:0.85;margin-bottom:24px;">Unsere KI analysiert in 5 Minuten ob dieser Beruf zu DEINEN Stärken und Interessen passt.</p>
<a href="/" style="display:inline-block;background:linear-gradient(135deg,#c9a84c,#e8c96a);color:#0f1f3d;padding:14px 32px;border-radius:8px;font-weight:700;text-decoration:none;">Jetzt KI-Analyse starten – nur 4,99€</a>
</div>

Wichtig: Alle Zahlen müssen realistisch und aktuell für Deutschland 2025 sein!`;
