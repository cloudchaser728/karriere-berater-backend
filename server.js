...
5. **5-STUFEN-ERFOLGSPLAN** (immer auf Karriereweg 1 bezogen!)
   ...
   <div class="section-container">
     ...
     <div class="step-item">
       ...
       <div style="margin-top:8px;">
         <a href="https://www.praktikum.de/search?q=[BERUFSBEZEICHNUNG KW1]&location=${locationEncoded}" target="_blank" class="btn" style="font-size:0.78rem; padding:5px 10px; margin:3px; display:inline-block; background:#f77f00;">🔬 Praktikum.de</a>
       </div></div>
     </div>
     <div class="step-item">
