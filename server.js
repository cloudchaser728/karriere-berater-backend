...
<div class="career-path-card">
  ...
  <h4>📋 Steckbrief – Was auf dich zukommt:</h4>
  <div class="info-box" style="background: linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%); border-left: 4px solid #16a34a;">
    <p><strong>🏫 Lernorte:</strong> [z.B. "3 Tage Betrieb + 2 Tage Berufsschule pro Woche"]</p>
    <p><strong>📚 Fächer & Lerninhalte:</strong> [Konkrete Fächer in der Berufsschule, z.B. "Rechnungswesen, Wirtschaftslehre, Deutsch, EDV, Fachpraxis"]</p>
    <p><strong>📝 Prüfungen:</strong> [z.B. "Zwischenprüfung nach dem 1. Jahr, Abschlussprüfung schriftlich + praktisch am Ende"]</p>
    <p><strong>📄 Bewerbung:</strong> [Was braucht man? z.B. "Lebenslauf, Anschreiben, letztes Schulzeugnis – direkt beim Ausbildungsbetrieb bewerben"]</p>
    <p><strong>⏰ Typischer Alltag:</strong> [z.B. "Abwechslung zwischen Theorie in der Schule und Praxis im Betrieb – von Tag 1 an echte Aufgaben"]</p>
    <p><strong>💪 Was dich erwartet:</strong> [Ehrliche Einschätzung: Was ist fordernd, was macht Spaß, worauf sollte man sich einstellen]</p>
    <p><strong>✅ Voraussetzungen:</strong> [Welcher Schulabschluss mindestens, hilfreiche Stärken, ggf. Eignungstest]</p>
  </div>
  ...
  <div class="info-box" style="background: linear-gradient(135deg, #fdf4ff 0%, #fae8ff 100%); border-left: 4px solid #9333ea;">
...
<div class="career-path-card">
  ...
  <h4>📋 Steckbrief – Was auf dich zukommt:</h4>
  <div class="info-box" style="background: linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%); border-left: 4px solid #16a34a;">
    <p><strong>🏛️ Studienform:</strong> [Präsenz / Dual / Online – und was das im Alltag bedeutet]</p>
    <p><strong>📚 Hauptfächer & Module:</strong> [Konkrete Fächer, z.B. "Analysis, Lineare Algebra, Programmierung, Datenbanken, Softwaretechnik, Projektmanagement"]</p>
    <p><strong>📝 Prüfungen & Abschluss:</strong> [z.B. "Klausuren & Hausarbeiten pro Semester, Bachelorarbeit am Ende (ca. 3 Monate Bearbeitungszeit)"]</p>
    <p><strong>📄 Bewerbung:</strong> [Was braucht man? z.B. "Abitur/Fachabitur, Online-Bewerbung über Hochschulstart oder direkt bei der Uni, ggf. Motivationsschreiben"]</p>
    <p><strong>⏰ Typischer Alltag:</strong> [z.B. "Vorlesungen + Seminare morgens, Selbststudium nachmittags, Gruppenarbeiten – viel Eigenorganisation nötig"]</p>
    <p><strong>💪 Was dich erwartet:</strong> [Ehrliche Einschätzung: Wo ist der Workload hoch, was ist besonders anspruchsvoll, z.B. Mathe-Anteil im 1. Semester]</p>
    <p><strong>✅ Voraussetzungen:</strong> [Abitur oder Fachabitur, NC-Grenze, ggf. Vorpraktikum oder Aufnahmetest]</p>
  </div>
