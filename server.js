...
- Fachkraft für Sprach- und Textdatenauswertung
...
═══════════════════════════════════════════════
🟣 UNI-STUDIENGÄNGE (NUR mit Abitur – KI darf bei Abitur AUSSCHLIESSLICH aus dieser Liste wählen!)
═══════════════════════════════════════════════
💻 TECHNOLOGIE & COMPUTER:
- Informatik (B.Sc.)
- Wirtschaftsinformatik (B.Sc.)
- Software Engineering (B.Sc.)
- Cyber Security / IT-Sicherheit (B.Sc.)
- Data Science (B.Sc.)
- Künstliche Intelligenz / KI (B.Sc.)
- Angewandte Informatik (B.Sc.)
- Computer Science (B.Sc.)
- Medieninformatik (B.Sc.)
- Bioinformatik (B.Sc.)
- Cloud Computing (B.Sc.)
- Game Engineering (B.Sc.)
- IT-Management (B.Sc.)
- Robotik (B.Sc.)
- Automatisierungstechnik (B.Sc.)
...
- Forensische Informatik (B.Sc.)
- Quanteninformatik (B.Sc.)
...
- Grafikdesign (B.A.)
- Modedesign (B.A.)
- Interaktionsdesign / UI-UX (B.A.)
- Film & Fernsehen / Regie (B.A.)
- Szenografie (B.A.)
- Freie Kunst (B.A.)
- Illustrationsdesign (B.A.)
- Motion Design (B.A.)
- Virtual Reality Design (B.A.)
- Kultur- & Medienmanagement (B.A.)
- Musikproduktion (B.A.)
- Sound Design (B.A.)
...
- Psychologie (B.Sc.)
- Lehramt Grundschule (Staatsexamen)
...
- Erwachsenenbildung (B.A.)
- Interkulturelle Kommunikation (B.A.)
- Musiktherapie (B.A.)
- Kunsttherapie (B.A.)
- Friedens- und Konfliktforschung (B.A.)
- Sozialpädagogik (B.A.)
- Coaching & Supervision (B.A.)

💰 WIRTSCHAFT & FINANZEN:
- Betriebswirtschaftslehre / BWL (B.Sc.)
- Volkswirtschaftslehre / VWL (B.Sc.)
- International Business (B.A.)
- Management & Controlling (B.Sc.)
- Finance & Banking (B.Sc.)
- Wirtschaftsprüfung & Steuern (B.Sc.)
...
- Psychologie klinisch (B.Sc.)
- Medizintechnik (B.Sc.)
- Pflegewissenschaft (B.Sc.)
- Hebammenwissenschaft (B.Sc.)
- Physiotherapie akademisiert (B.Sc.) ← NUR als Uni-Studiengang, NICHT als Ausbildung!
- Ergotherapie akademisiert (B.Sc.) ← NUR als Uni-Studiengang, NICHT als Ausbildung!
- Gesundheitsmanagement (B.Sc.)
- Public Health (B.Sc.)
- Molekulare Medizin (B.Sc.)
- Sportmedizin (B.Sc.)
- Ernährungswissenschaften / Ökotrophologie (B.Sc.)
- Medizinische Biotechnologie (B.Sc.)
- Biomedizin (B.Sc.)
- E-Health (B.Sc.)
- Neurowissenschaften (B.Sc.)
- Gesundheitsinformatik (B.Sc.)
- Notfallmanagement (B.Sc.)
- Biomedizinische Technik (B.Sc.)

⚙️ INGENIEURWESEN & BAU:
...
- Schiffbau & Meerestechnik (B.Sc.)
- Restaurierungswissenschaften (B.Sc.)
...
- Mathematik (B.Sc.)
- Geographie (B.Sc.)
- Nachhaltigkeitsmanagement (B.Sc.)
- Renewable Energy / Erneuerbare Energien (B.Sc.)
- Biotechnologie (B.Sc.)
- Zoologie (B.Sc.)
- Botanik (B.Sc.)
...
- Kriminalistik (B.Sc.)
- Sicherheitsmanagement (B.Sc.)
- Risiko- & Katastrophenmanagement (B.Sc.)
- Cyber Security Management (B.Sc.)
- Forensische Wissenschaften (B.Sc.)
...
- Flugzeugbau (B.Sc.)
- Satellitentechnik (B.Sc.)
- Luftverkehrsmanagement (B.Sc.)
- Space Systems Engineering (B.Sc.)
- Astronomie (B.Sc.)
- Astrophysik (B.Sc.)
- Aerodynamik (B.Sc.)
- Airport Management (B.Sc.)

═══════════════════════════════════════════════
🔵 DUALE STUDIENGÄNGE / FH (nur mit Fachabitur oder Abitur)
═══════════════════════════════════════════════
⚠️ NUR DIESE STUDIENGÄNGE bei Fachabitur verwenden!

💻 TECHNOLOGIE & COMPUTER:
- Fachinformatiker + B.Sc. Informatik
...
- Motion Design
- Medienmanagement (Kreativwirtschaft)
...
ABITUR → IMMER 3x STUDIENGÄNGE AUS DER 🟣 UNI-LISTE OBEN!
❌ KEINE Ausbildungen, KEINE FH-Studiengänge, KEINE Dualen Studiengänge
❌ Physiotherapeut = VERBOTEN (Ausbildung/Berufsfachschule)
❌ Ergotherapeut = VERBOTEN (Ausbildung)
❌ Notfallsanitäter = VERBOTEN (Ausbildung)
❌ Alles aus der 🟢 Ausbildungsliste = VERBOTEN
❌ Alles aus der 🔵 FH-Liste = VERBOTEN
✅ NUR Studiengänge aus der 🟣 UNI-LISTE: z.B. Humanmedizin, Psychologie, Informatik, BWL, Biologie, Gesundheitswissenschaften...

FACHABITUR → IMMER 3x STUDIENGÄNGE AUS DER 🔵 FH-LISTE OBEN!
❌ KEINE Ausbildungen, KEINE Uni-Studiengänge
✅ NUR Studiengänge aus der 🔵 FH-LISTE oder Duale Studiengänge

REALSCHULE / HAUPTSCHULE → IMMER 3x BERUFE AUS DER 🟢 AUSBILDUNGSLISTE OBEN!
❌ KEIN Studium egal welcher Art
✅ NUR Berufe aus der 🟢 Ausbildungsliste
...
🚨 ABITUR ERKANNT → 3x UNIVERSITÄTSSTUDIENGÄNGE! KEINE Ausbildungen! KEINE FH! KEINE Dualen Studiengänge!

WAS EIN UNI-STUDIENGANG IST:
✅ Bachelor of Science (B.Sc.) an einer Universität
✅ Bachelor of Arts (B.A.) an einer Universität  
✅ Staatsexamen (Medizin, Jura, Pharmazie, Lehramt)
✅ Diplom an einer Universität

WAS KEIN UNI-STUDIENGANG IST – VERBOTEN BEI ABITUR+UNI:
❌ Physiotherapeut → ist eine Berufsfachschule/Ausbildung – VERBOTEN!
❌ Ergotherapeut → ist eine Ausbildung – VERBOTEN!
❌ Notfallsanitäter → ist eine Ausbildung – VERBOTEN!
❌ Erzieher → ist eine Ausbildung – VERBOTEN!
❌ Fitnesstrainer → ist eine Ausbildung – VERBOTEN!
❌ Duales Studium XY → ist FH, kein Uni-Studiengang – VERBOTEN!

MEDIZIN-REGEL: Gesundheitsinteresse → Humanmedizin B.Sc./Staatsexamen, Gesundheitswissenschaften B.Sc., Biomedizin B.Sc., Pflegewissenschaft B.Sc. an Uni – NIEMALS Physiotherapeut oder Notfallsanitäter!
SPORT-REGEL: Sportinteresse → Sportwissenschaften B.Sc., Sportmedizin, Bewegungswissenschaft B.Sc. an Uni – NIEMALS Fitnesstrainer!
` : ''}
...
2. **DEINE TOP 3 KARRIEREWEGE**
   ...
   **🚨 PFLICHT: JOB-BUTTONS – FÜR JEDEN DER 3 KARRIEREWEGE ZWINGEND!**
   ...
   <div class="job-search-buttons">
     ...
     <a href="https://www.azubiyo.de/berufe/?q=[BERUFSBEZEICHNUNG]" target="_blank" class="btn" style="margin: 10px 5px; display: inline-block; background: #7c3aed;">🎓 Azubiyo</a>
   </div>
...
- Kein Markdown, kein Plain-Text, nur sauberes HTML!`;
        ...
        const bildungswegRegel = (formData.education === 'abitur' || formData.education === 'abitur_ziel')
            ? 'ABITUR → KW1, KW2 und KW3 = NUR echte Uni-Studiengänge (B.Sc./B.A./Staatsexamen an Universität)! Physiotherapeut, Ergotherapeut, Notfallsanitäter, Erzieher, Fitnesstrainer und alle Ausbildungsberufe sind VERBOTEN! Duale Studiengänge sind VERBOTEN!'
            : (formData.education === 'fachabitur' || formData.education === 'fachabitur_ziel')
