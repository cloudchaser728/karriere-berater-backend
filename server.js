...
// In-memory store for formData (avoids Stripe 500-char metadata limit)
...
app.post('/create-checkout-session', async (req, res) => {
    try {
        ...
        // Store formData in memory (keyed by session.id) so we don't hit Stripe's 500-char metadata limit
