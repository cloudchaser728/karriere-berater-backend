...
5. **5-STUFEN-ERFOLGSPLAN** (immer auf Karriereweg 1 bezogen!)
   ...
   <div class="section-container">
     ...
     <div class="step-item">
       ...
       <div style="margin-top:8px;">
         <a href="https://www.meinpraktikum.de/praktikum/suche?q=[BERUFSBEZEICHNUNG KW1]&location=${locationEncoded}" target="_blank" class="btn" style="font-size:0.78rem; padding:5px 10px; margin:3px; display:inline-block; background:#f77f00;">🔬 Praktikum.de</a>
       </div></div>
     </div>
     <div class="step-item">
...
<a href="https://www.meinpraktikum.de" target="_blank" class="btn" style="margin: 10px 5px; display: inline-block; background: #7c3aed;">🔬 Praktikum.de</a>
` : ''}
