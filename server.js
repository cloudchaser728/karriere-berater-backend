   ...
   <div class="section-container">
     ...
     <div class="step-item">
       ...
       <div style="margin-top:10px;">
         <a href="https://www.youtube.com/results?search_query=[BERUFSBEZEICHNUNG KW1]+Ausbildung+Erfahrung" target="_blank" class="btn" style="margin: 5px 5px; display: inline-block; background: #ff0000;">▶ YouTube: Beruf kennenlernen</a>
         <a href="https://www.google.com/search?q=[BERUFSBEZEICHNUNG KW1]+Berufsalltag+Erfahrungen" target="_blank" class="btn btn-accent" style="margin: 5px 5px; display: inline-block;">🔍 Google: Berufsbild</a>
       </div></div>
     </div>
     <div class="step-item">
       ...
       <div style="margin-top:10px;">
         <a href="https://www.ausbildung.de/suche?what=[BERUFSBEZEICHNUNG KW1]&where=${locationEncoded}" target="_blank" class="btn" style="margin: 5px 5px; display: inline-block; background: #3b82f6;">📋 Freie Stellen in ${location}</a>
         <a href="https://www.azubiyo.de/berufe/?q=[BERUFSBEZEICHNUNG KW1]" target="_blank" class="btn" style="margin: 5px 5px; display: inline-block; background: #7c3aed;">🎓 Azubiyo</a>
       </div></div>
     </div>
     <div class="step-item">
       ...
       <div style="margin-top:10px;">
         <a href="https://www.linkedin.com/search/results/people/?keywords=[BERUFSBEZEICHNUNG KW1]" target="_blank" class="btn" style="margin: 5px 5px; display: inline-block; background: #0077b5;">💼 LinkedIn: Kontakte finden</a>
       </div></div>
     </div>
     <div class="step-item">
       ...
       <div style="margin-top:10px;">
         <a href="https://www.google.com/search?q=[BERUFSBEZEICHNUNG KW1]+Bewerbung+Tipps+${location}" target="_blank" class="btn btn-accent" style="margin: 5px 5px; display: inline-block;">📝 Bewerbungstipps</a>
         <a href="https://de.indeed.com/jobs?q=[BERUFSBEZEICHNUNG KW1]&l=${locationEncoded}" target="_blank" class="btn" style="margin: 5px 5px; display: inline-block; background: #10b981;">💼 Indeed</a>
       </div></div>
     </div>
     <div class="step-item">
       ...
       <div style="margin-top:10px;">
         <a href="https://www.google.com/search?q=[BERUFSBEZEICHNUNG KW1]+Karriere+Aufstieg+Gehalt" target="_blank" class="btn" style="margin: 5px 5px; display: inline-block; background: #1a4d2e;">📈 Karrieremöglichkeiten</a>
       </div></div>
     </div>
   </div>
...
<a href="https://www.praktikum.de" target="_blank" class="btn" style="margin: 10px 5px; display: inline-block; background: #7c3aed;">🔬 Praktikum.de</a>
` : ''}
