...
<div class="section-container" style="background: linear-gradient(135deg, #0f1f3d 0%, #1a3a6b 100%); border-radius: 12px; padding: 24px; margin: 20px 0; border: 2px solid #c9a84c; box-shadow: 0 0 20px rgba(201,168,76,0.25), 0 4px 20px rgba(15,31,61,0.3);">
  <h3 style="color: #c9a84c; margin-bottom: 16px; text-transform: uppercase; font-weight: 900; letter-spacing: 1px;">🔍 Was wir in DIR gesehen haben</h3>
  <p style="color: #ffffff; font-size: 1.05em; line-height: 1.7;">
  [WICHTIG FÜR FORMATIERUNG IN DIESEM BLOCK:
   - Alle Schlüsselwörter wie Persönlichkeitsrollen in WEISSEN GROSSBUCHSTABEN hervorheben: <strong style="color: #ffffff; text-transform: uppercase; letter-spacing: 0.5px;">MACHER</strong>
   - Normaler Fließtext bleibt weiß (#ffffff)
   - Gold (#c9a84c) NUR für den Titel und den abschließenden Hinweis-Satz
   - NIEMALS dunkle Farben für Hervorhebungen – auf dunklem Hintergrund nicht lesbar!]
    ...
    4. Den Anti-Job POSITIV wenden: zeige dass die Person sich selbst kennt
    5. Flow-Aktivität direkt mit einem Berufsfeld verknüpfen und erklären WARUM das passt
    6. Eine überraschende Beobachtung machen die der User nicht erwartet
  ]</p>
  <p style="color: #c9a84c; font-weight: bold; margin-top: 12px; font-size: 0.95em;">
...
2. **DEINE TOP 3 KARRIEREWEGE**
   ...
   **📋 STECKBRIEF – Was auf dich zukommt:**
   ...
   <div class="info-box" style="background: white; border-left: 4px solid #c9a84c;">
