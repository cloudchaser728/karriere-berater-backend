...
STOPP nach Karriereweg 2! Karriereweg 3, Weiterbildung und Nächste Schritte kommen im nächsten Schritt.`;
        ...
        // ═══════════════════════════════════════════════
        const t0 = Date.now();
        let beruf1 = null, beruf2 = null, beruf3 = null, preSelectOk = false;
...
Wähle GENAU 3 unterschiedliche, zum Profil bestmöglich passende Berufe/Studiengänge aus der Berufsliste oben aus – keine Wiederholungen, keine Synonyme desselben Berufs.
...
Denk dir kurz (2-4 Sätze) durch, welche Berufe basierend auf dem Profil am besten passen und warum – das hilft dir, die wirklich besten 3 zu finden statt naheliegende Standardvorschläge zu wählen. Danach folgt dein finales Ergebnis.

Antworte in diesem Format:
KURZE ÜBERLEGUNG: [2-4 Sätze, warum genau diese 3 Berufe am besten zum Profil passen]
ERGEBNIS: {"beruf1":"<Beruf>","beruf2":"<Beruf>","beruf3":"<Beruf>"}
...
Das JSON-Objekt nach "ERGEBNIS:" muss exakt diesem Format entsprechen – keine zusätzlichen Felder, keine Markdown-Codeblöcke um das JSON.`;
            ...
            if (beruf1 && beruf2 && beruf3 && uniqueCount === 3) {
                preSelectOk = true;
                console.log(`✅ Vorab-Berufsauswahl (${Date.now() - t0}ms): ${beruf1} | ${beruf2} | ${beruf3}`);
            } else {
