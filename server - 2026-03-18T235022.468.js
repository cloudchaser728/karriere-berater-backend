...
2. **DEINE TOP 3 KARRIEREWEGE**
   ...
   **🚨 PFLICHT: JOB-BUTTONS – FÜR JEDEN DER 3 KARRIEREWEGE ZWINGEND!**
   ...
   <div class="job-search-buttons">
     ...
     <a href="https://www.azubiyo.de/ausbildungsplaetze/?berufsfeld=[BERUFSBEZEICHNUNG]&ort=${locationEncoded}" target="_blank" class="btn" style="margin: 10px 5px; display: inline-block; background: #7c3aed;">🎓 Azubiyo</a>
   </div>
   ...
   <div class="section-container">
     ...
     <div class="step-item">
       ...
       <div style="margin-top:8px;">
         <a href="https://www.youtube.com/results?search_query=[BERUFSBEZEICHNUNG KW1]+Ausbildung+Erfahrung" target="_blank" class="btn" style="font-size:0.78rem; padding:5px 10px; margin:3px; display:inline-block; background:#ff0000;">▶ YouTube</a>
         <a href="https://www.google.com/search?q=[BERUFSBEZEICHNUNG KW1]+Berufsalltag+Erfahrungen" target="_blank" class="btn btn-accent" style="font-size:0.78rem; padding:5px 10px; margin:3px; display:inline-block;">🔍 Berufsbild</a>
       </div></div>
     </div>
     <div class="step-item">
       ...
       <div style="margin-top:8px;">
         <a href="https://www.azubiyo.de/ausbildungsplaetze/?berufsfeld=[BERUFSBEZEICHNUNG KW1]&ort=${locationEncoded}" target="_blank" class="btn" style="font-size:0.78rem; padding:5px 10px; margin:3px; display:inline-block; background:#7c3aed;">🎓 Stellen auf Azubiyo</a>
       </div></div>
     </div>
     <div class="step-item">
       ...
       <div style="margin-top:8px;">
         <a href="https://www.praktikum.de/s?q=[BERUFSBEZEICHNUNG KW1]&location=${locationEncoded}" target="_blank" class="btn" style="font-size:0.78rem; padding:5px 10px; margin:3px; display:inline-block; background:#f77f00;">🔬 Praktikum.de</a>
         <a href="https://www.google.com/search?q=Schnupperpraktikum+[BERUFSBEZEICHNUNG KW1]+${location}" target="_blank" class="btn btn-accent" style="font-size:0.78rem; padding:5px 10px; margin:3px; display:inline-block;">🔍 Schnupperpraktikum</a>
       </div></div>
     </div>
     <div class="step-item">
