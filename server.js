...
Wähle GENAU 3 unterschiedliche, zum Profil passende Berufe/Studiengänge aus der Berufsliste oben aus – keine Wiederholungen, keine Synonyme desselben Berufs.
Berücksichtige dabei: Interessen, Persönlichkeit (Holland-Code), die Bildungsweg-Regel oben, und die genannten No-Gos.

Antworte AUSSCHLIESSLICH mit einem validen JSON-Objekt in genau diesem Format, ohne Erklärung, ohne Markdown-Codeblock:
{"beruf1":"<Beruf>","beruf2":"<Beruf>","beruf3":"<Beruf>"}`;
