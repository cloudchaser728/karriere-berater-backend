...
<div class="info-box" style="background: #fff7ed; border-left: 4px solid #f97316;">
  <p><strong>🏢 Wer bietet Praktika an?</strong> [Konkrete Firmen und Unternehmenstypen in ${formData.location || 'deiner Region'} die in DIESEM Bereich Praktika vergeben – nenne 3-5 bekannte Arbeitgeber]</p>
  <p><strong>⏰ Wann bewerben?</strong> [Typische Fristen – z.B. "3-6 Monate vorher, viele Firmen nehmen ganzjährig auf"]</p>
  <p><strong>📄 Was brauchst DU?</strong> [Lebenslauf, kurzes Anschreiben, letztes Zeugnis – was in DIESEM Bereich besonders wichtig ist]</p>
  <p><strong>💰 Wird das Praktikum bezahlt?</strong> [Schulpraktikum meist unbezahlt, Pflichtpraktikum 300-800€/Monat, freiwillig bis 1.200€ – konkret für diesen Bereich]</p>
...
<div class="job-search-buttons">
  <a href="https://www.google.com/search?q=[BERUFSBEZEICHNUNG]+praktikum+${encodeURIComponent(formData.location || 'Deutschland')}" target="_blank" class="btn" style="margin: 10px 5px; display: inline-block; background: #f97316;">
    🔍 Praktikum in ${formData.location || 'Deutschland'} suchen
  </a>
  <a href="https://www.praktikum.de/search?q=[BERUFSBEZEICHNUNG]&location=${encodeURIComponent(formData.location || 'Deutschland')}" target="_blank" class="btn" style="margin: 10px 5px; display: inline-block; background: #3b82f6;">
    📋 Praktikum.de
  </a>
  <a href="https://de.indeed.com/jobs?q=[BERUFSBEZEICHNUNG]+praktikum&l=${encodeURIComponent(formData.location || 'Deutschland')}" target="_blank" class="btn" style="margin: 10px 5px; display: inline-block; background: #10b981;">
    💼 Indeed Praktikum
  </a>
</div>

✅ Praktikumsblock Karriereweg 1 ← PFLICHT (ersetze [BERUFSBEZEICHNUNG] mit exaktem Berufsnamen!)
✅ Praktikumsblock Karriereweg 2 ← PFLICHT
✅ Praktikumsblock Karriereweg 3 ← PFLICHT
` : ''}
