...
2. **DEINE TOP 3 KARRIEREWEGE**
   ...
   **📋 STECKBRIEF – Was auf DICH zukommt:**
   ...
   🚨 PFLICHT: Der komplette Block MUSS im <div class="info-box"> eingeschlossen sein – NIEMALS die <p>-Zeilen ohne diesen umschließenden div ausgeben! JEDE Zeile MUSS mit dem exakt vorgegebenen Emoji beginnen – NIEMALS Emojis weglassen!
...
- Grids: display:grid; grid-template-columns:repeat(auto-fit,minmax(320px,1fr)); gap:12px;
