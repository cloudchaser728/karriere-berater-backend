...
${formData.bildungsweg_ziel === 'uni' ? `
🚨🚨🚨 ABSOLUTES VERBOT – ABITUR + UNI GEWÄHLT 🚨🚨🚨
ALLE 3 KARRIEREWEGE = NUR UNIVERSITÄTSSTUDIENGÄNGE (🟣)
❌ VERBOTEN: Notfallsanitäter, Physiotherapeut, Erzieher, oder JEDE andere Ausbildung
❌ VERBOTEN: FH-Studiengänge, Duale Studiengänge
✅ ERLAUBT: NUR Uni-Studiengänge mit Staatsexamen oder Bachelor/Master an Universität
MEDIZIN-REGEL: Gesundheitsinteresse → Humanmedizin, Zahnmedizin, Pharmazie, Gesundheitswissenschaften B.Sc. – NIEMALS Notfallsanitäter oder Physiotherapeut!
SPORT-REGEL: Sportinteresse + Uni → Sportwissenschaften B.Sc., Sportmedizin, Sportpsychologie – NIEMALS Fitnesstrainer oder Sportlehrer-Ausbildung!
Wenn DU eine Ausbildung empfiehlst obwohl UNI gewählt wurde → KRITISCHER FEHLER!` :
  formData.bildungsweg_ziel === 'fh' ? `
🚨🚨🚨 ABSOLUTES VERBOT – ABITUR + FH GEWÄHLT 🚨🚨🚨
ALLE 3 KARRIEREWEGE = NUR FH/DUALE STUDIENGÄNGE (🔵)
❌ VERBOTEN: Jede Ausbildung
❌ VERBOTEN: Uni-Studiengänge
✅ ERLAUBT: NUR FH-Studiengänge oder Duale Studiengänge` :
  formData.bildungsweg_ziel === 'ausbildung' ? `→ Will AUSBILDUNG trotz Abitur: Karriereweg 1 = Universitätsstudium (passend zu den Interessen), Karriereweg 2 + 3 = Ausbildungsberufe! Hinweis: Mit Abitur hast du immer noch die Option zu studieren – Ausbildung ist trotzdem eine starke Wahl!` :
  `→ UNSICHER: 2 Universitätsstudiengänge + 1 Ausbildung als Alternative!`}
` : ''}
...
${formData.bildungsweg_ziel === 'fh' ? `
🚨🚨🚨 ABSOLUTES VERBOT – FACHABITUR + FH GEWÄHLT 🚨🚨🚨
ALLE 3 KARRIEREWEGE = NUR FH/DUALE STUDIENGÄNGE (🔵)
❌ VERBOTEN: Jede Ausbildung
❌ VERBOTEN: Uni-Studiengänge
✅ ERLAUBT: NUR FH-Studiengänge oder Duale Studiengänge` :
  formData.bildungsweg_ziel === 'ausbildung' ? `→ Will AUSBILDUNG trotz Fachabitur: Karriereweg 1 = FH/Duales Studium (passend zu den Interessen), Karriereweg 2 + 3 = Ausbildungsberufe! Hinweis: Mit Fachabitur hast du immer noch die Option an eine FH zu gehen – Ausbildung ist trotzdem eine starke Wahl!` :
