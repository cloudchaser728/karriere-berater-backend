...
- **PERSÖNLICHKEITSROLLE: ${Array.isArray(formData.rolle) ? formData.rolle.join(', ') : (formData.rolle || 'k.A.')}** ← WÖRTLICH in der Analyse verwenden!
...
<div class="career-path-card">
  ...
  <h4>📍 Freie Stellen ${location === 'Deutschlandweit' ? 'deutschlandweit' : `in ${location}`}:</h4>
  <div class="job-search-buttons">
    ...
    ` : `
    <a href="https://www.google.com/search?q=[BERUFSBEZEICHNUNG]+ausbildung+${locationEncoded}&ibp=htl;jobs" target="_blank" class="btn btn-accent" style="margin: 10px 5px; display: inline-block;">
      🔍 Ausbildungsplätze finden
    </a>
    <a href="https://www.ausbildung.de/suche?what=[BERUFSBEZEICHNUNG]&where=${locationEncoded}" target="_blank" class="btn" style="margin: 10px 5px; display: inline-block; background: #3b82f6;">
      📋 Auf Ausbildung.de suchen
    </a>
    <a href="https://de.indeed.com/jobs?q=[BERUFSBEZEICHNUNG]+ausbildung&l=${locationEncoded}" target="_blank" class="btn" style="margin: 10px 5px; display: inline-block; background: #10b981;">
      💼 Auf Indeed suchen
    </a>
    `}
  </div>
...
<div class="job-search-buttons">
  ...
  ` : `
  <a href="https://www.google.com/search?q=[BERUFSBEZEICHNUNG]+${locationEncoded}&ibp=htl;jobs" target="_blank" class="btn btn-accent" style="margin: 10px 5px; display: inline-block;">
    🔍 Jobs auf Google finden
  </a>
  <a href="https://de.indeed.com/jobs?q=[BERUFSBEZEICHNUNG]&l=${locationEncoded}" target="_blank" class="btn" style="margin: 10px 5px; display: inline-block; background: #10b981;">
    💼 Auf Indeed suchen
  </a>
  <a href="https://www.stepstone.de/jobs/[BERUFSBEZEICHNUNG]/in-${locationEncoded}" target="_blank" class="btn" style="margin: 10px 5px; display: inline-block; background: #3b82f6;">
    📋 Auf StepStone suchen
  </a>
  `}
</div>
...
<div class="career-path-card">
  ...
  <h4>📍 Studiengänge finden ${location === 'Deutschlandweit' ? 'deutschlandweit' : `in ${location}`}:</h4>
  <div class="job-search-buttons">
    ${location === 'Deutschlandweit' ? `
    <a href="https://www.google.com/search?q=[STUDIENGANG]+Studium+Deutschland" target="_blank" class="btn btn-accent" style="margin: 10px 5px; display: inline-block;">
      🎓 Studiengang suchen
    </a>
    ...
    <a href="https://www.google.com/search?q=[STUDIENGANG]+duales+Studium+Deutschland" target="_blank" class="btn" style="margin: 10px 5px; display: inline-block; background: #10b981;">
      💼 Duales Studium
    </a>
    ` : `
    <a href="https://www.google.com/search?q=[STUDIENGANG]+Studium+${location}" target="_blank" class="btn btn-accent" style="margin: 10px 5px; display: inline-block;">
      🎓 Studiengang suchen
    </a>
    <a href="https://www.studycheck.de/suche?q=[STUDIENGANG]&location=${locationEncoded}" target="_blank" class="btn" style="margin: 10px 5px; display: inline-block; background: #3b82f6;">
      📚 StudyCheck
    </a>
    <a href="https://www.google.com/search?q=[STUDIENGANG]+duales+Studium+${location}" target="_blank" class="btn" style="margin: 10px 5px; display: inline-block; background: #10b981;">
      💼 Duales Studium
    </a>
    `}
  </div>
...
<h4>📍 Jobs für [STUDIENGANG]-Absolventen ${location === 'Deutschlandweit' ? 'deutschlandweit' : `in ${location}`}:</h4>
<div class="job-search-buttons">
  ${location === 'Deutschlandweit' ? `
  ...
  <a href="https://de.linkedin.com/jobs/search?keywords=[BERUFSBEZEICHNUNG]&location=${locationEncoded}" target="_blank" class="btn" style="margin: 10px 5px; display: inline-block; background: #0077b5;">
    💼 LinkedIn Jobs
  </a>
  <a href="https://www.stepstone.de/jobs/[BERUFSBEZEICHNUNG]/in-${locationEncoded}" target="_blank" class="btn" style="margin: 10px 5px; display: inline-block; background: #3b82f6;">
    📋 StepStone
...
Füge bei den Job-Such-Buttons (ausbildung.de / Indeed / StepStone / Hochschulkompass) einen ZUSÄTZLICHEN vierten Button hinzu – nur diesen einen extra Praktikums-Button, die anderen Buttons bleiben normal:
  ...
  <a href="https://www.google.com/search?q=[BERUFSBEZEICHNUNG]+Praktikum+${locationEncoded}" target="_blank" class="btn" style="margin: 10px 5px; display: inline-block; background: #f97316;">
    🎯 Praktikum finden
  </a>
