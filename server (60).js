...
✅ Karriereweg 2: Gehaltstabelle + Buttons + Block A + B + C ← PFLICHT
✅ Karriereweg 3: Gehaltstabelle + Buttons + Block A + B + C ← PFLICHT (auch der letzte!)
...
Sei KONKRET und REALISTISCH! Beruecksichtige STRIKT den Bildungsabschluss!`;
        ...
        const systemMessage = `DU bist ein erfahrener Karriere- und Studienberater mit 15+ Jahren Erfahrung. DU gibst konkrete, umsetzbare Empfehlungen und sprichst die Leute IMMER mit DU an - nie mit Sie! DU bist wie ein guter Freund der hilft.
...
🚨 JETZT NUR FOLGENDES AUSGEBEN (NICHT MEHR!):
1. Karriereweg 3 (komplett mit Tabelle, Buttons, Steckbrief, Zukunftstrend, Warum, Alternativen)
2. Uni/Hochschul-Empfehlungen (falls relevant für den Bildungsabschluss)
3. Weiterbildungs-Tipps für alle 3 Karrierewege
4. Konkrete Nächste Schritte (5 Schritte mit lokalen Firmennamen)

NUR diese Sektionen – Profil und Karriereweg 1 & 2 wurden bereits ausgegeben.`;
