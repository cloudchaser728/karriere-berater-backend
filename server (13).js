...
- Wo bewerben: Direkte Links als Buttons:
  <a href="https://www.arbeitsagentur.de/jobsuche/suche?was=${beruf}&angebotsart=4" target="_blank" style="display:inline-block;background:#1a4d2e;color:white;padding:10px 20px;border-radius:8px;text-decoration:none;margin:5px;font-size:0.9rem;">🏛️ Arbeitsagentur</a>
  <a href="https://de.indeed.com/jobs?q=${beruf}+ausbildung" target="_blank" style="display:inline-block;background:#003a9b;color:white;padding:10px 20px;border-radius:8px;text-decoration:none;margin:5px;font-size:0.9rem;">💼 Indeed</a>
  <a href="https://www.google.com/search?q=${beruf}+Ausbildung+Stelle&ibp=htl;jobs" target="_blank" style="display:inline-block;background:#c9a84c;color:#0f1f3d;padding:10px 20px;border-radius:8px;text-decoration:none;margin:5px;font-size:0.9rem;">🔍 Google Jobs</a>

Verwende dieses CSS-Design (inline styles):
- Farben: primary #0f1f3d, accent #c9a84c, bg #f7f8fc
- Karten: background:white; border-radius:12px; padding:24px; margin-bottom:20px; box-shadow:0 2px 12px rgba(15,31,61,0.06)
- Überschriften: font-family:'Crimson Pro',serif; color:#0f1f3d; border-bottom:2px solid #c9a84c; padding-bottom:10px; margin-bottom:16px; font-size:1.6rem
- Gehaltstabelle: width:100%; border-collapse:collapse mit th background:#0f1f3d color:white padding:12px
- Roadmap-Schritte: background:#f7f8fc; border-left:4px solid #c9a84c; padding:16px; border-radius:0 8px 8px 0; margin-bottom:12px
...
<h2 style="font-family:'Crimson Pro',serif;font-size:1.8rem;margin-bottom:12px;">Passt ${beruf} wirklich zu DIR?</h2>
<p style="opacity:0.85;margin-bottom:8px;">Viele wählen einen Beruf der gut klingt – aber nicht zu ihrer Persönlichkeit passt.</p>
<p style="opacity:0.85;margin-bottom:24px;">Unsere KI analysiert in 5 Minuten ob dieser Beruf zu DEINEN Stärken, Interessen und Zielen passt.</p>
...
<p style="margin-top:12px;font-size:0.85rem;opacity:0.6;">3 konkrete Karrierewege · Persönlicher Aktionsplan · Gehaltsvergleich</p>
</div>

Wichtig: Alle Zahlen müssen realistisch und aktuell für Deutschland 2025 sein! Sei konkret und präzise – keine vagen Aussagen!`;
