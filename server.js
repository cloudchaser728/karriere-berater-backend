...
2. **DEINE TOP 3 KARRIEREWEGE**
   ...
   **🚨 PFLICHT: JOB-BUTTONS – FÜR JEDEN DER 3 KARRIEREWEGE ZWINGEND!**
   ...
   Wähle je nach Typ des Karrierewegs UND SITUATION die passende Button-Gruppe:

   🚨 SITUATIONS-REGEL FÜR LINKS:
   - situation = 'unemployed' (Arbeitssuchend) → IMMER "WENN BERUFSTÄTIGE/ABSOLVENTEN" verwenden → Job-Links, KEIN Azubiyo, KEINE Ausbildung.de!
   - situation = 'quereinsteiger' (Quereinsteiger) → IMMER "WENN BERUFSTÄTIGE/ABSOLVENTEN" verwenden → Job-Links, KEIN Azubiyo, KEINE Ausbildung.de!
   - situation = 'working' (Berufstätig) → IMMER "WENN BERUFSTÄTIGE/ABSOLVENTEN" verwenden!
   - situation = 'ausbildung' (Azubi) → je nach empfohlenem Weg (Ausbildung/Job/Studium)
   - situation = 'school' (Schüler) → je nach Bildungsweg (Ausbildung/Studium/öffentlicher Dienst)
