...
5. **WEITERBILDUNGS-TIPPS**
   ...
   NICHT generisch! Wenn du z.B. Fachinformatiker, Mechatroniker und Kaufmann empfohlen hast, dann
   ...
   <div class="section-container">
     ...
     <ul>
       <li><strong>Kostenlos:</strong> [Konkrete Kurse/Kanäle NUR für diesen Beruf, z.B. "YouTube: 'The Coding Train' für Programmierung" oder "Coursera: 'Excel Skills for Business' für Kaufleute"]</li>
       <li><strong>Udemy:</strong> [Konkrete Kurse NUR für diesen Beruf mit typischem Preis, z.B. "Udemy: 'Meister Elektrotechnik Vorbereitung' – ca. 15€"]</li>
       <li><strong>Zertifikat:</strong> [1 konkretes Zertifikat das direkt zu diesem Beruf passt, z.B. "IHK-Zertifikat Industriemechanik" oder "CompTIA A+ für IT-Berufe"]</li>
     </ul>
     ...
     <ul>
       ...
       <li><strong>Zertifikat:</strong> [1 konkretes Zertifikat das direkt zu diesem Beruf passt]</li>
     </ul>
...
6. **KONKRETE NÄCHSTE SCHRITTE**
   ...
   🚨 WICHTIG: Alle 5 Schritte MÜSSEN konkret auf die empfohlenen Berufe, den Standort (${formData.location})
   und den Bildungsabschluss zugeschnitten sein! KEIN "Informiere dich auf berufenet.de"!
   
   BEISPIELE für gute konkrete Schritte:
   - SCHLECHT: "Informiere dich über Berufe"
   - GUT: "Suche heute noch auf ausbildung.de nach 'Fachinformatiker Anwendungsentwicklung ${formData.location}' und merke dir 5 Betriebe"
   
   - SCHLECHT: "Schreibe Bewerbungen"
   - GUT: "Bereite deinen Lebenslauf vor – bei IT-Ausbildungen legen Firmen wie SAP, Telekom oder lokale IT-Betriebe Wert auf Eigeninitiative: Erwähne eigene Projekte oder Kurse"
   
   - SCHLECHT: "Starte deine Ausbildung"
   - GUT: "Bewerbungsfristen für Ausbildung 2025 laufen meist Oktober–Januar – trage diese Deadline in deinen Kalender ein und habe bis dann Lebenslauf + Anschreiben fertig"
   ...
   <div class="section-container">
     ...
     <div class="step-item">
       ...
       <div class="step-content">
         <strong>Sofort (heute noch):</strong> [KONKRET: z.B. "Geh auf ausbildung.de und suche nach '[Karriereweg 1]' in ${formData.location} – speichere 3-5 Betriebe die dich interessieren" – NICHT generisch!]
       </div>
     </div>
     ...
     <div class="step-item">
       ...
       <div class="step-content">
         <strong>Diese Woche:</strong> [KONKRET: z.B. "Schreibe [konkrete Firma aus der Region/Branche] direkt an und frage nach einem Schnupperpraktikum im Bereich [Karriereweg 1] – eine E-Mail reicht!" – NICHT generisch!]
       </div>
     </div>
     ...
     <div class="step-item">
       ...
       <div class="step-content">
         <strong>Nächster Monat:</strong> [KONKRET: z.B. "Erstelle deinen Lebenslauf mit canva.com (kostenlos, professionelle Vorlagen) und schreibe dein erstes Anschreiben für [Karriereweg 1] – nutze die Tipps aus dem Steckbrief oben" – NICHT generisch!]
       </div>
     </div>
     ...
     <div class="step-item">
       ...
       <div class="step-content">
         <strong>In 3-6 Monaten:</strong> [KONKRET: z.B. "Bewerbungsschluss für Ausbildungsstart 2025 ist meist Januar/Februar – bis dahin solltest du 5-10 Bewerbungen rausgeschickt haben. Für Studium: NC-Check auf hochschulstart.de" – NICHT generisch!]
       </div>
     </div>
     ...
     <div class="step-item">
       ...
       <div class="step-content">
         <strong>Langfristig:</strong> [KONKRET: z.B. "Nach dem Abschluss als [Karriereweg 1]: Weiterbildung zum [konkreter Karriere-Turbo aus oben] anstreben – das bedeutet +[X]€ Gehalt im Monat" – NICHT generisch!]
       </div>
     </div>
   </div>
